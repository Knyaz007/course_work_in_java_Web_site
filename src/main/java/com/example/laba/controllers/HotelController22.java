...
@Controller
@RequestMapping("/hotels22")
public class HotelController22 {
...
for (Hotel hotel : hotels) {
    List<Service> services = hotel.getServices(); // или другой источник
...
model.addAttribute("hotelServicesMap", hotelServicesMap);
     ...
     // Средняя оценка
      ...
      /*  List<Double> avgEval = commentRepository.findAverageEvaluationByHotelId(hotelId); */
        for (Hotel hotel : hotels) {
